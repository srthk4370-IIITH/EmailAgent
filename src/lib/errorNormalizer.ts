...
const RULES: NormalizerRule[] = [
  ...
  },
  {
    ...
    reason: "The middleware verification secret is missing or unavailable.",
    fix: "Open Settings, refresh runtime configuration, then sign in again.",
    fixNowPath: "/settings",
    test: (text) => text.includes("auth_not_configured") || text.includes("verify-secret"),
  },
  {
    code: "OPENAI_AUTH",
    category: "AUTH",
